...
/*
*A class for querying a database modelling the Wine Market.
*Schema of this database is specified in Wine_Market_Modelling directory.
*@author Alvaro Naranjo
*@author Anh Phuong Tran
*
*/
...
public class Talk_to_Database {
  ...
  //CONSTRUCTOR
	...
	*/
  Talk_to_Database() throws ClassNotFoundException {
	try{
  ...
  public boolean disconnectDB() throws SQLException {
	...
	/*Inserts row into the winemaker table. wmname is the name of the
	*winemaker. Checks if the country with cid exists. Returns true if
	*the insertion was successful, false otherwise.*/
  public boolean insertWinemaker(int wmid, String wmname, int cid) throws SQLException {
	...
	/*Returns the number of winemakers in country cname. Returns -1 if
	* an error occurs.*/
	...
	/* Returns a string with the information of winemaker with the winemaker 	* id wmid. The output is "wmname:countryname". Order by wmname ASC.
	* Returns an empty string "" if the winemaker does not exist.*/
   public String getWinemakerInfo(int wmid) throws SQLException {
	...
	/* Changes the country name of the coutnry cid to the country name
	* supplied (newCname). Returns true if the change was successful, false
	* otherwise.*/
	...
	/* Deletes the country identified by cid. Returns true if the
  ...
  public boolean deleteCountry(int cid) throws SQLException {
	...
	/* Returns a string with all the wines a winemaker with id wmid 
	* produced. The list of wines follows the format:
	* wname1:country1:bestbeforeyear1:msrp1:rating1#wname2...*/
  public String listWines(int wmid) throws SQLException {
	...
	/*Increases the ratings of all the wines produced by the winemaker
	* with id wmid in year wyear by 1. Returns true if the update was
...
public boolean updateRatings(int wmid, int wyear) throws SQLException {
	...
	/* Finds the wine makers with highest and lowest average rating
	* from all winemakers in Spain that produce BOTH 'Red' and 'Rose'
	* wines sold at a discount in the month of October 2013.*/
 public String query7() throws SQLException {
	...
	/* Creates a table in the DBMS containing al the winemakers in
	* the country Spain who produced wines of all colours ('Red',
	* 'Rose', 'White'). The name of the table is winemakersForAllWines*/
